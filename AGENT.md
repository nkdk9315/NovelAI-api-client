...
| `action` | `"generate" \| "img2img" \| "inpaint"` | `"generate"` | 生成モード |
| `source_image` | `string \| Buffer` | `undefined` | img2img/inpaint入力画像 |
| `img2img_strength` | `number` | `0.62` | 変換強度（0=元画像に近い） |
| `img2img_noise` | `number` | `0.0` | ノイズ追加量 |
| `mask` | `string \| Buffer` | `undefined` | インペイントマスク画像 |
